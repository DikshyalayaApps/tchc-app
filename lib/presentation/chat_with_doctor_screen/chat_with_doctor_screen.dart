...
import 'package:tchc/widgets/app_bar/appbar_subtitle_three.dart';
import 'package:tchc/widgets/app_bar/appbar_trailing_image.dart';
...
class ChatWithDoctorScreen extends GetWidget<ChatWithDoctorController> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            bottomNavigationBar: _buildNinetyNineRow()));
  }
  ...
  /// Common widget
  Widget _buildChatTile({required String messageText}) {
    return Container(
