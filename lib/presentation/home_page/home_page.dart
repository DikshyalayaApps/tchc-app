...
import 'package:tchc/widgets/app_bar/appbar_subtitle.dart';
...
import 'package:tchc/widgets/custom_search_view.dart';
  ...
  Widget _buildTopDoctors() {
    return Column(children: [
      ...
      Obx(() => GridView.builder(
          ...
          itemCount: controller.homeModelObj.value.doctorItemList.value.length,
          itemBuilder: (context, index) {
